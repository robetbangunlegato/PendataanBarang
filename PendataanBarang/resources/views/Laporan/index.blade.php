...
@section('content')
    <div class="container text-center">
        ...
        <div class="row">
            <form action="{{ route('tahun') }}" method="get" style="display: flex;">
                <div class="col-3">
                ...
                <div class="col-6 text-start" style="margin-left: 1em">
                    <button class="btn btn-primary" type="submit">LIHAT</button>
                </div>
            </form>
        </div>
        <form action="{{ route('cetaktahun') }}" method="get" class="text-end">
            @csrf
